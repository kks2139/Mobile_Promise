    ...
    public void onClickLogin(View v)
    {
        if (isConnected()) {
            ...
            // call AsynTask to perform network operation on separate thread
                ...
                new LoginAsyncTask().execute("http://ec2-52-79-154-139.ap-northeast-2.compute.amazonaws.com:3000/login_check/matching");
    ...
    private class LoginAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.matches(".*Incorrect username or password.*"))
            {
                ...
                //main.putExtra("loginID", loginID.getText());
                //main.putExtra("loginPass", loginPass.getText());
